...
A: {"query_type": "specific_factoid", "confidence": 0.95, "reasoning": "Asks for a single configuration value."}

Q: "Tell me everything about the authentication module"
A: {"query_type": "entity_focused", "confidence": 0.90, "reasoning": "Centres on a specific named component/entity."}

Q: "What are the main architectural patterns used in this system?"
A: {"query_type": "global_thematic", "confidence": 0.88, "reasoning": "Broad overview across the whole codebase."}

Q: "How does the user role connect to the permission system and API rate limits?"
A: {"query_type": "multi_hop", "confidence": 0.92, "reasoning": "Requires connecting two distinct entities."}

Q: "Tell me about error handling"
A: {"query_type": "vague_exploratory", "confidence": 0.80, "reasoning": "Vague; vocabulary gap between query and docs."}

Q: "What configuration options exist and also how do I deploy to production?"
...
def _heuristic_classify(query: str) -> dict:
    ...
    # Default fallback → hybrid (safe middle ground)
    return {
        "query_type": "specific_factoid",
        "confidence":  0.50,
        "strategy":    STRATEGY_MAP["specific_factoid"],
...
class QueryRouter:
    ...
    def classify(self, query: str) -> dict:
        ...
        # LLM unavailable or returned garbage — use heuristic
        log.debug("QueryRouter: LLM classification failed, using heuristic for: %.80s", query)
